...
<body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Faça login na sua conta.</p>
        </section>
        ...
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="{{ route('login') }}">
                ...
                <div class="flex justify-end">
                    <a href="#" class="text-sm text-purple-600 hover:text-purple-700 hover:underline mb-6">Esqueceu a senha?</a>
                </div>
    ...
    <div class="max-w-lg mx-auto text-center mt-12 mb-6">
        <p class="text-white">Não tem uma conta? <a href="{{ route('register') }}" class="font-bold hover:underline">Registre-se aqui</a>.</p>
    </div>
</body>
</html>
